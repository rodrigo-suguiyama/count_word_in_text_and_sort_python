...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/rodrigo/Estudos/Python/count_text_word/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/rodrigo/Estudos/Python/count_text_word/venv/bin/deactivate.nu'
